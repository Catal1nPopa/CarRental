...
{
    public class ElectricMotorcycleBuilder : IVehicleBuilder
    {
        private ElectricMotorcycle _motorcycle = new ElectricMotorcycle();
        ...
        public IVehicleBuilder SetBatteryCapacity(int batteryCapacity) { _motorcycle.BatteryCapacity = batteryCapacity; return this; }
        ...
        {
            _motorcycle.BatteryCapacity = electricCapacity;
            return this;
        }
